    ...
    <div class="row">
        ...
        <div class="col-md-8">
            ...
            if(isset($_GET['p_id'])){
                ...
                $update_statement = mysqli_prepare($con, "UPDATE posts SET post_views_count = post_views_count + 1 WHERE post_id = ?");
                ...
                if(isset($_SESSION['username']) && is_admin($_SESSION['username']) ) {
                    ...
                    $stmt1 = mysqli_prepare($con, "SELECT post_title, post_user, post_date, post_image, post_content FROM posts WHERE post_id = ?");


                } else {
                    $stmt2 = mysqli_prepare($con , "SELECT post_title, post_user, post_date, post_image, post_content FROM posts WHERE post_id = ? AND post_status = ? ");
